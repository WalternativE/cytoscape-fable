...
module Cytoscape =
    ...
    type [<AllowNullLiteral>] CoreGraphManipulation =
        ...
        abstract add: eles: U3<ElementDefinition, ResizeArray<ElementDefinition>, Collection> -> CollectionElements
        /// Remove elements in collecion or match the selector from the graph and return them.
        abstract remove: eles: U2<Collection, Selector> -> CollectionElements
        ...
        abstract collection: ?eles: U2<Selector, ResizeArray<CollectionElements>> -> CollectionElements
        /// Get an element from its ID in a very performant way.
        abstract getElementById: id: string -> CollectionElements
        /// Get elements in the graph matching the specified selector.
        /// http://js.cytoscape.org/#cy.$
        abstract ``$``: selector: Selector -> CollectionElements
        /// Get elements in the graph matching the specified selector.
        /// http://js.cytoscape.org/#cy.$
        abstract elements: ?selector: Selector -> CollectionElements
        ...
        abstract filter: selector: U2<Selector, (Singular -> float -> CollectionElements -> bool)> -> CollectionElements
    ...
    type [<AllowNullLiteral>] CoreGraphManipulationExt =
        ...
        abstract scratch: ?``namespace``: string * ?value: obj option -> Scratchpad
        ...
        /// <param name="namespace">A namespace string.</param>
        abstract removeScratch: ``namespace``: string -> unit
    ...
    type [<AllowNullLiteral>] CoreEvents =
        ...
        abstract on: events: EventNames * handler: EventHandler -> unit
        abstract on: events: EventNames * selector: Selector * handler: EventHandler -> unit
        abstract on: events: EventNames * selector: Selector * data: obj option * handler: EventHandler -> unit
        abstract on: eventsMap: CoreEventsOnEventsMap * ?selector: Selector * ?data: obj option -> unit
        abstract bind: events: EventNames * handler: EventHandler -> unit
        abstract bind: events: EventNames * selector: Selector * handler: EventHandler -> unit
        abstract bind: events: EventNames * selector: Selector * data: obj option * handler: EventHandler -> unit
        abstract bind: eventsMap: CoreEventsBindEventsMap * ?selector: Selector * ?data: obj option -> unit
        abstract listen: events: EventNames * handler: EventHandler -> unit
        abstract listen: events: EventNames * selector: Selector * handler: EventHandler -> unit
        abstract listen: events: EventNames * selector: Selector * data: obj option * handler: EventHandler -> unit
        abstract listen: eventsMap: CoreEventsListenEventsMap * ?selector: Selector * ?data: obj option -> unit
        abstract addListener: events: EventNames * handler: EventHandler -> unit
        abstract addListener: events: EventNames * selector: Selector * handler: EventHandler -> unit
        abstract addListener: events: EventNames * selector: Selector * data: obj option * handler: EventHandler -> unit
        abstract addListener: eventsMap: CoreEventsAddListenerEventsMap * ?selector: Selector * ?data: obj option -> unit
        ...
        /// <param name="events">A space separated list of event names.</param>
        /// <param name="handler">The handler function that is called when one of the specified events occurs.</param>
        abstract one: events: EventNames * handler: EventHandler -> unit
        /// <summary>Bind to events that occur in the graph, and trigger the handler only once.</summary>
        /// <param name="events">A space separated list of event names.</param>
        /// <param name="selector">A selector to specify elements for which the handler is triggered.</param>
        /// <param name="handler">The handler function that is called when one of the specified events occurs.</param>
        abstract one: events: EventNames * selector: Selector * handler: EventHandler -> unit
        /// <summary>Bind to events that occur in the graph, and trigger the handler only once.</summary>
        /// <param name="events">A space separated list of event names.</param>
        /// <param name="selector">A selector to specify elements for which the handler is triggered.</param>
        /// <param name="data">A plain object which is passed to the handler in the event object argument.</param>
        /// <param name="handler">The handler function that is called when one of the specified events occurs.</param>
        abstract one: events: EventNames * selector: Selector * data: obj option * handler: EventHandler -> unit
        /// <summary>Bind to events that occur in the graph, and trigger the handler only once.</summary>
        /// <param name="eventsMap">A map of event names to handler functions.</param>
        /// <param name="selector">A selector to specify elements for which the handler is triggered.</param>
        /// <param name="data">A plain object which is passed to the handler in the event object argument.</param>
        abstract one: eventsMap: CoreEventsOneEventsMap * ?selector: Selector * ?data: obj option -> unit
        ...
        abstract off: events: EventNames * ?selector: Selector * ?handler: EventHandler -> unit
        abstract off: eventsMap: CoreEventsOffEventsMap * ?selector: Selector -> unit
        abstract unbind: events: EventNames * ?selector: Selector * ?handler: EventHandler -> unit
        abstract unbind: eventsMap: CoreEventsUnbindEventsMap * ?selector: Selector -> unit
        abstract unlisten: events: EventNames * ?selector: Selector * ?handler: EventHandler -> unit
        abstract unlisten: eventsMap: CoreEventsUnlistenEventsMap * ?selector: Selector -> unit
        abstract removeListener: events: EventNames * ?selector: Selector * ?handler: EventHandler -> unit
        abstract removeListener: eventsMap: CoreEventsRemoveListenerEventsMap * ?selector: Selector -> unit
        ...
        abstract trigger: events: EventNames * ?extraParams: ResizeArray<obj option> -> unit
        abstract emit: events: EventNames * ?extraParams: ResizeArray<obj option> -> unit
        ...
        abstract ready: fn: EventHandler -> unit
    ...
    type [<AllowNullLiteral>] CoreViewportManipulation =
        ...
        abstract fit: ?eles: Collection * ?padding: float -> CollectionElements
        /// Reset the graph to the default zoom level and panning position.
        /// http://js.cytoscape.org/#cy.reset
        abstract reset: unit -> CollectionElements
        ...
        abstract pan: ?renderedPosition: Position -> unit
        ...
        abstract panBy: renderedPosition: Position -> unit
        ...
        abstract panningEnabled: bool: bool -> unit
        ...
        abstract userPanningEnabled: bool: bool -> unit
        /// Get the zoom level.
        ...
        abstract zoom: ?level: U2<float, ZoomOptions> -> unit
        ...
        abstract zoomingEnabled: ?bool: bool -> unit
        ...
        abstract userZoomingEnabled: ?bool: bool -> unit
        ...
        abstract minZoom: zoom: float -> unit
        ...
        abstract maxZoom: zoom: float -> unit
        ...
        abstract viewport: zoom: float * pan: Position -> unit
        ...
        abstract boxSelectionEnabled: bool: bool -> unit
        ...
        abstract autolock: bool: bool -> unit
        ...
        /// <param name="bool">A truthy value enables autolocking; a falsey value disables it.</param>
        abstract autoungrabify: bool: bool -> unit
        ...
        /// <param name="bool">A truthy value enables autolocking; a falsey value disables it.</param>
        abstract autounselectify: bool: bool -> unit
    ...
    type [<AllowNullLiteral>] AnimationOptions =
        ...
        abstract easing: bool option with get, set
        /// complete - A function to call when the animation is done. 
        abstract complete: unit -> unit
        /// step - A function to call each time the animation steps. 
        abstract step: unit -> unit
    ...
    type [<AllowNullLiteral>] CoreAnimation =
        ...
        abstract animation: options: AnimationOptions -> obj option
        ...
        abstract delayAnimation: duration: float -> unit
    ...
    type [<AllowNullLiteral>] CoreLayout =
        ...
        abstract layout: layout: LayoutOptions -> LayoutManipulation
    ...
    type [<AllowNullLiteral>] ExportOptions =
        ...
        abstract output: U3<string, string, string> option with get, set
    ...
    type [<AllowNullLiteral>] CoreExport =
        ...
        abstract png: ?options: ExportOptions -> string
        /// Export the current graph view as a JPG image in Base64 representation.
        abstract jpg: ?options: ExportOptions -> string
        /// Export the current graph view as a JPG image in Base64 representation.
        abstract jpeg: ?options: ExportOptions -> string
    ...
    type [<AllowNullLiteral>] Collection =
        ...
        inherit CollectionIteration
        inherit CollectionBuildingUnion
        inherit CollectionAlgorithms

    /// ele  --> Cy.Singular
    /// a collection of a single element (node or edge)
    type [<AllowNullLiteral>] Singular =
    ...
    type [<AllowNullLiteral>] SingularElement =
        inherit EdgeSingular
        inherit NodeSingular
    ...
    type [<AllowNullLiteral>] CollectionGraphManipulation =
        ...
        abstract remove: unit -> CollectionElements
        /// Put removed elements back into the graph.
        /// http://js.cytoscape.org/#eles.restore
        abstract restore: unit -> CollectionElements
        ...
        abstract clone: unit -> CollectionElements
        /// Get a new collection containing clones (i.e. copies) of the elements in the calling collection.
        /// http://js.cytoscape.org/#eles.clone
        abstract copy: unit -> CollectionElements
    ...
    type [<AllowNullLiteral>] CollectionEvents =
        ...
        abstract on: events: EventNames * selector: string * data: obj option * handler: EventHandler -> unit
        abstract on: events: EventNames * selector: string * handler: EventHandler -> unit
        abstract on: events: EventNames * handler: EventHandler -> unit
        ...
        abstract one: events: EventNames * selector: string * data: obj option * handler: EventHandler -> unit
        abstract one: events: EventNames * selector: string * handler: EventHandler -> unit
        abstract one: events: EventNames * handler: EventHandler -> unit
        /// http://js.cytoscape.org/#eles.once
        abstract once: events: EventNames * selector: string * data: obj option * handler: EventHandler -> unit
        abstract once: events: EventNames * selector: string * handler: EventHandler -> unit
        abstract once: events: EventNames * handler: EventHandler -> unit
        /// http://js.cytoscape.org/#eles.off
        /// alias unbind, unlisten, removeListener
        abstract off: events: EventNames * ?selector: string * ?handler: EventHandler -> unit
        /// http://js.cytoscape.org/#eles.trigger
        /// alias: emit
        abstract trigger: events: EventNames * ?extra: ResizeArray<string> -> unit
    ...
    type [<AllowNullLiteral>] CollectionData =
        ...
        abstract removeData: ?names: string -> CollectionElements
        abstract removeAttr: ?names: string -> CollectionElements
    ...
    type [<AllowNullLiteral>] SingularData =
        ...
        abstract data: name: string * value: obj option -> unit
        ...
        abstract data: obj: obj option -> unit
    ...
    type [<AllowNullLiteral>] NodeSingularPosition =
        ...
        abstract position: dimension: PositionDimension * ?value: Position -> unit
        ...
        abstract position: pos: Position -> unit
        ...
        abstract renderedPosition: dimension: PositionDimension * value: Position -> unit
        abstract renderedPosition: pos: NodeSingularPositionRenderedPositionPos -> unit
        ...
        abstract renderedPoint: dimension: PositionDimension * value: Position -> unit
        abstract renderedPoint: pos: NodeSingularPositionRenderedPointPos -> unit
        ...
        abstract relativePosition: dimension: PositionDimension * value: Position -> unit
        abstract relativePosition: pos: NodeSingularPositionRelativePositionPos -> unit
        ...
        abstract relativePoint: dimension: PositionDimension * value: Position -> unit
        abstract relativePoint: pos: NodeSingularPositionRelativePointPos -> unit
    ...
    type [<AllowNullLiteral>] ElementPositionFunction =
        [<Emit "$0($1...)">] abstract Invoke: ele: CollectionElements * ix: float -> unit

    type [<AllowNullLiteral>] ElementCollectionFunction =
        [<Emit "$0($1...)">] abstract Invoke: ele: CollectionElements * ix: float * eles: CollectionElements -> unit
    ...
    type [<AllowNullLiteral>] NodeCollectionPosition =
        ...
        abstract positions: handler: U2<ElementPositionFunction, Position> -> unit
        abstract modelPositions: handler: U2<ElementPositionFunction, Position> -> unit
        abstract points: handler: U2<ElementPositionFunction, Position> -> unit
        /// Allow the user to grab the nodes.
        /// http://js.cytoscape.org/#nodes.grabify
        abstract grabify: unit -> unit
        /// Disallow the user to grab the nodes.
        /// http://js.cytoscape.org/#nodes.ungrabify
        abstract ungrabify: unit -> unit
    ...
    type [<AllowNullLiteral>] CollectionLayout =
        ...
        abstract layout: options: LayoutOptions -> CollectionElements
        abstract makeLayout: options: LayoutOptions -> CoreLayout
        abstract createLayout: options: LayoutOptions -> CoreLayout
    ...
    type [<AllowNullLiteral>] LayoutPositionOptions =
        ...
        abstract eles: CollectionElements with get, set
    ...
    type [<AllowNullLiteral>] NodeSingularLayout =
        ...
        /// <param name="options">The layout options object.</param>
        abstract layoutDimensions: options: LayoutDimensionOptions -> obj
    ...
    type [<AllowNullLiteral>] CollectionStyle =
        ...
        abstract addClass: classes: ClassNames -> unit
        ...
        abstract removeClass: classes: ClassNames -> unit
        ...
        abstract toggleClass: classes: ClassNames * ?toggle: bool -> unit
        ...
        abstract classes: ?classes: ClassNames -> unit
        ...
        abstract flashClass: classes: ClassNames * ?duration: float -> unit
        /// <summary>Get or set a particular style property value.</summary>
        ...
        abstract style: ?name: string * ?value: obj option -> obj option
    ...
    type [<AllowNullLiteral>] SingularStyle =
        ...
        abstract renderedStyle: unit -> obj
        abstract renderedStyle: name: string -> obj option
        abstract renderedCss: unit -> obj
    ...
    type [<AllowNullLiteral>] CollectionAnimation =
        ...
        abstract animate: options: U2<ElementAnimateOptionPos, ElementAnimateOptionRen> -> unit
        ...
        abstract delay: duration: float * complete: (unit -> unit) -> unit
        ...
        abstract stop: clearQueue: bool * jumpToEnd: bool -> unit
        /// Remove all queued animations for the elements.
        /// http://js.cytoscape.org/#eles.clearQueue
        abstract clearQueue: unit -> unit

    type [<AllowNullLiteral>] SingularAnimationOptions =
        /// A position to which the elements will be animated. 
        abstract position: Position with get, set
        /// A rendered position to which the elements will be animated. 
        abstract renderedPosition: Position with get, set
    ...
    type [<AllowNullLiteral>] SingularAnimation =
        ...
        abstract animation: options: SingularAnimationOptions -> unit
    ...
    type [<AllowNullLiteral>] CollectionComparision =
        ...
        /// <param name="eles">The other elements to compare to.</param>
        abstract allAreNeighbors: eles: Collection -> bool
        /// <summary>Determine whether all elements in the specified collection are in the neighbourhood of the calling collection.</summary>
        /// <param name="eles">The other elements to compare to.</param>
        abstract allAreNeighbours: eles: Collection -> bool
        ...
        abstract some: test: (CollectionElements -> float -> CollectionElements -> bool) * ?thisArg: obj option -> bool
        ...
        /// eles - The collection of elements being tested.</param>
        /// <param name="thisArg">[optional] The value for this within the test function.</param>
        abstract every: test: (CollectionElements -> float -> CollectionElements -> bool) * ?thisArg: obj option -> bool

    /// http://js.cytoscape.org/#collection/iteration
    type [<AllowNullLiteral>] CollectionIteration =
        ...
        abstract each: each: (CollectionElements -> float -> CollectionElements -> U2<unit, bool>) * ?thisArg: obj option -> unit
        abstract forEach: each: (CollectionElements -> float -> CollectionElements -> U2<unit, bool>) * ?thisArg: obj option -> unit
        ...
        abstract eq: index: float -> CollectionElements
        /// Get an element at a particular index in the collection.
        [<Emit "$0[$1]{{=$2}}">] abstract Item: index: float -> CollectionElements with get, set
        /// Get the first element in the collection.
        abstract first: unit -> CollectionElements
        /// Get the last element in the collection.
        abstract last: unit -> CollectionElements
        ...
        /// Use negative numbers to select from the end of an array.</param>
        abstract slice: ?start: float * ?``end``: float -> CollectionElements

    type [<AllowNullLiteral>] CollectionBuildingUnionFunc =
        [<Emit "$0($1...)">] abstract Invoke: eles: U3<Collection, ResizeArray<Collection>, Selector> -> CollectionElements

    type [<AllowNullLiteral>] CollectionBuildingDifferenceFunc =
        [<Emit "$0($1...)">] abstract Invoke: eles: U2<Collection, Selector> -> CollectionElements
    ...
    type [<AllowNullLiteral>] CollectionBuildingUnion =
        ...
        abstract absoluteComplement: unit -> CollectionElements
        abstract abscomp: unit -> CollectionElements
        abstract complement: unit -> CollectionElements
        /// Get the elements in both this collection and another specified collection.
        /// http://js.cytoscape.org/#eles.intersection
        abstract intersection: CollectionSymmetricDifferenceFunc with get, set
        abstract intersect: CollectionSymmetricDifferenceFunc with get, set
        abstract ``and``: CollectionSymmetricDifferenceFunc with get, set
        ...
        abstract diff: selector: U2<Selector, Collection> -> obj
        ...
        abstract sort: sort: (CollectionElements -> CollectionElements -> float) -> CollectionElements
        ...
        abstract map: fn: (CollectionElements -> float -> CollectionElements -> obj option) * ?thisArg: obj option -> ResizeArray<obj option>
        ...
        abstract reduce: fn: (obj option -> CollectionElements -> float -> CollectionElements -> obj option) -> ResizeArray<float>
        ...
        abstract min: fn: (CollectionElements -> float -> CollectionElements -> obj option) * ?thisArg: obj option -> obj
        ...
        abstract max: fn: (CollectionElements -> float -> CollectionElements -> obj option) * ?thisArg: obj option -> obj
    ...
    type [<AllowNullLiteral>] CollectionTraversing =
        ...
        abstract neighborhood: ?selector: Selector -> CollectionElements
        /// <summary>Get the open neighbourhood of the elements.
        /// 
        /// The neighbourhood returned by this function is a bit different than the traditional definition of a "neighbourhood":
        /// This returned neighbourhood includes the edges connecting the collection to the neighbourhood. This gives you more flexibility.
        /// An open neighbourhood is one that does not include the original set of elements. If unspecified, a neighbourhood is open by default.</summary>
        /// <param name="selector">[optional] An optional selector that is used to filter the resultant collection.</param>
        abstract openNeighborhood: ?selector: Selector -> CollectionElements
        ...
        /// <param name="selector">[optional] An optional selector that is used to filter the resultant collection.</param>
        abstract closedNeighborhood: ?selector: Selector -> CollectionElements
        ...
        abstract components: unit -> Collection
    ...
    type [<AllowNullLiteral>] EdgeSingularTraversing =
        ...
        abstract source: ?selector: Selector -> NodeCollection
        /// <summary>Get target node of this edge.</summary>
        /// <param name="selector">An optional selector that is used to filter the resultant collection.
        /// http://js.cytoscape.org/#edge.target</param>
        abstract target: ?selector: Selector -> NodeCollection
    ...
    type [<AllowNullLiteral>] NodeCollectionTraversing =
        ...
        abstract edgesWith: eles: U2<Collection, Selector> -> EdgeCollection
        /// <summary>Get the edges coming from the collection (i.e. the source) going to another collection (i.e. the target).</summary>
        /// <param name="eles">The other collection.</param>
        abstract edgesTo: eles: U2<Collection, Selector> -> EdgeCollection
        ...
        /// <param name="selector">[optional] An optional selector that is used to filter the resultant collection.</param>
        abstract outgoers: ?selector: Selector -> EdgeCollection
        ...
        /// <param name="selector">[optional] An optional selector that is used to filter the resultant collection.</param>
        abstract successors: ?selector: Selector -> EdgeCollection
        /// <summary>Get edges (and their sources) coming into the nodes in the collection.</summary>
        /// <param name="selector">[optional] An optional selector that is used to filter the resultant collection.</param>
        abstract incomers: ?selector: Selector -> EdgeCollection
        ...
        /// <param name="selector">[optional] An optional selector that is used to filter the resultant collection.</param>
        abstract predecessors: ?selector: Selector -> EdgeCollection
    ...
    type [<AllowNullLiteral>] SearchVisitFunction =
        [<Emit "$0($1...)">] abstract Invoke: i: float * depth: float * v: NodeCollection * e: EdgeCollection * u: NodeCollection -> bool

    type [<AllowNullLiteral>] SearchFirstOptions =
        /// The root nodes (selector or collection) to start the search from.
        abstract roots: U2<Selector, Collection> with get, set
    ...
    type [<AllowNullLiteral>] SearchFirstResult =
        ...
        abstract path: CollectionElements with get, set
    ...
    type [<AllowNullLiteral>] SearchDijkstraOptions =
        ...
        abstract root: U2<Selector, Collection> with get, set
    ...
    type [<AllowNullLiteral>] SearchDijkstraResult =
        ...
        abstract pathTo: node: NodeSingular -> Collection

    /// http://js.cytoscape.org/#eles.aStar
    type [<AllowNullLiteral>] SearchAStarOptions =
        abstract root: U2<Selector, Collection> with get, set
        abstract goal: U2<Selector, Collection> with get, set
        abstract weight: WeightFn option with get, set
    ...
    type [<AllowNullLiteral>] SearchAStarResult =
        ...
        abstract path: Collection with get, set
    ...
    type [<AllowNullLiteral>] SearchFloydWarshallResult =
        ...
        abstract path: fromNode: U2<NodeSingular, CollectionSelection> * toNode: U2<NodeSingular, Selector> -> Collection
    ...
    type [<AllowNullLiteral>] SearchBellmanFordResult =
        ...
        abstract pathTo: node: U2<NodeSingular, Selector> -> Collection
    ...
    type [<AllowNullLiteral>] SearchPageRankResult =
        ...
        abstract rank: node: NodeCollection -> unit
    ...
    type [<AllowNullLiteral>] CollectionAlgorithms =
        ...
        /// http://js.cytoscape.org/#eles.bellmanFord
        abstract bellmanFort: options: SearchBellmanFordOptions -> SearchBellmanFordResult
        ...
        /// http://js.cytoscape.org/#eles.kruskal
        abstract kruskal: handler: (EdgeCollection -> float) -> unit
    ...
    module Css =
        ...
        type [<AllowNullLiteral>] EdgeLine =
            ...
            abstract ``curve-style``: U4<string, string, string, string> option with get, set
        ...
        type [<AllowNullLiteral>] EdgeArror =
        ...
        type [<AllowNullLiteral>] Labels =
            ...
            abstract ``source-label``: string with get, set
            /// The text to display for an edge’s target label.
            abstract ``target-label``: string with get, set
            /// Basic font styling:
            /// The colour of the element’s label.
            abstract color: Colour with get, set
            /// The opacity of the label text, including its outline.
            abstract ``text-opacity``: float with get, set
            /// A comma-separated list of font names to use on the label text.
            abstract ``font-family``: string with get, set
            /// The size of the label text.
            /// https://developer.mozilla.org/en-US/docs/Web/CSS/font-family
            abstract ``font-size``: float with get, set
            /// A CSS font style to be applied to the label text.
            /// https://developer.mozilla.org/en-US/docs/Web/CSS/font-style
            abstract ``font-style``: FontStyle with get, set
            /// A CSS font weight to be applied to the label text.
            abstract ``font-weight``: FontWeight with get, set
            /// A transformation to apply to the label text.
            abstract ``text-transform``: TextTranformation with get, set
            /// Wrapping text:
            ...
            abstract ``text-wrap``: U2<string, string> with get, set
            ...
            abstract ``text-max-width``: string with get, set
            /// Node label alignment:
            /// The vertical alignment of a node’s label.
            abstract ``text-halign``: U3<string, string, string> with get, set
            /// The vertical alignment of a node’s label.
            abstract ``text-valign``: U3<string, string, string> with get, set
            /// Edge label alignment:
            /// For the source label of an edge, how far from the source node the label should be placed.
            abstract ``source-text-offset``: float with get, set
            /// For the target label of an edge, how far from the target node the label should be placed.
            abstract ``target-text-offset``: float with get, set
            /// Margins:
            /// A margin that shifts the label along the x- axis.
            abstract ``text-margin-x``: float with get, set
            /// A margin that shifts the label along the y- axis.
            abstract ``text-margin-y``: float with get, set
            /// (For the source label of an edge.)
            abstract ``source-text-margin-x``: float with get, set
            /// (For the source label of an edge.)
            abstract ``source-text-margin-y``: float with get, set
            /// (For the target label of an edge.)
            abstract ``target-text-margin-x``: float with get, set
            /// (For the target label of an edge.)
            abstract ``target-text-margin-y``: float with get, set
            /// Rotating text:
            ...
            abstract ``text-rotation``: float with get, set
            /// (For the source label of an edge.)
            abstract ``source-text-rotation``: float with get, set
            /// (For the target label of an edge.)
            abstract ``target-text-rotation``: float with get, set
            /// Outline:
            /// The colour of the outline around the element’s label text.
            abstract ``text-outline-color``: Colour with get, set
            /// The opacity of the outline on label text.
            abstract ``text-outline-opacity``: float with get, set
            /// The size of the outline on label text.
            abstract ``text-outline-width``: float with get, set
            /// Shadow:
            /// The shadow blur distance.
            abstract ``text-shadow-blur``: float with get, set
            /// The colour of the shadow.
            abstract ``text-shadow-color``: Colour with get, set
            ...
            abstract ``min-zoomed-font-size``: float with get, set
    ...
    type [<AllowNullLiteral>] GridLayoutOptions =
        ...
        abstract position: nodeid: string -> obj
    ...
    type [<AllowNullLiteral>] LayoutEvents =
        ...
        /// <param name="events">A space separated list of event names.</param>
        /// <param name="data">[optional] A plain object which is passed to the
        /// handler in the event object argument.</param>
        /// <param name="handler">The handler function that is called
        /// when one of the specified events occurs.</param>
        abstract on: events: EventNames * data: obj option * handler: EventHandler -> unit
        abstract bind: events: EventNames * data: obj option * handler: EventHandler -> unit
        abstract listen: events: EventNames * data: obj option * handler: EventHandler -> unit
        abstract addListener: events: EventNames * data: obj option * handler: EventHandler -> unit
        ...
        /// <param name="handler">The handler function that is called when one of the specified events occurs.</param>
        abstract one: events: EventNames * handler: EventHandler -> unit
        abstract one: events: EventNames * data: obj option * handler: EventHandler -> unit
        /// <summary>Remove event handlers on the layout.
        /// http://js.cytoscape.org/#layout.off</summary>
        /// <param name="events">A space separated list of event names.</param>
        /// <param name="handler">[optional] A reference to the handler function to remove.</param>
        abstract off: events: EventNames * ?handler: EventHandler -> unit
        abstract unbind: events: EventNames * ?handler: EventHandler -> unit
        abstract unlisten: events: EventNames * ?handler: EventHandler -> unit
        abstract removeListener: events: EventNames * ?handler: EventHandler -> unit
